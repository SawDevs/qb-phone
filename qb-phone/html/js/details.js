function LoadPlayerMoneys(){
    ...
    if(QB.Phone.Data.PlayerData.metadata["phonecachedata"][PlayerStateID].balance != null){
        var PlayerBalance = QB.Phone.Data.PlayerData.metadata["phonecachedata"][PlayerStateID].balance;
        $(".details-balance").html(PlayerBalance)
    }else{
        $(".details-balance").html("0")
    }
