...
$(document).on('click', '.phone-recent-call', function(e){
    ...
    $.post('https://qb-phone/CallContact', JSON.stringify({
        ...
        if (status.simCard == false){
            QB.Phone.Notifications.Add("fas fa-phone", "Phone", "You don't have simcard!");
            return
        }
        if (status.enoughCredit == false){
            QB.Phone.Notifications.Add("fas fa-phone", "Phone", "You don't have enought credit!");
            return
        }
